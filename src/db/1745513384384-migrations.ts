...
export class Migrations1745513384384 implements MigrationInterface {
  name = 'Migrations1745513384384';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."flight_prices_seat_class_enum" AS ENUM('economy', 'business')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(`DROP TYPE "public"."tickets_seat_class_enum_old"`);
  }
